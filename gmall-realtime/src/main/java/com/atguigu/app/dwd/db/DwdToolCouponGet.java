...
//程  序：Mock -> Mysql(binlog) -> Maxwell -> Kafka(ZK) -> DwdToolCouponGet -> Kafka(ZK)
...
//        System.setProperty("HADOOP_USER_NAME", "atguigu");
        ...
        tableEnv.executeSql("create table `topic_db`( " +
                ...
                "`type` string, " +
                "`ts` string " +
                ")" + MyKafkaUtil.getKafkaDDL("topic_db", "coupon_get_220212"));
        ...
        tableEnv.executeSql("create table dwd_tool_coupon_get ( " +
                ...
                "get_time string, " +
                "ts string " +
                ")" + MyKafkaUtil.getInsertKafkaDDL("coupon_get_220212"));
